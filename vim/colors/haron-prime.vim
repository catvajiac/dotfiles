...
let s:red             = "81a500" " includes
let s:lyme            = "81a500" " datatypes
let s:peach           = "cca68e"
let s:orange          = "cd96e5" " integers
let s:wine            = "af8787"
let s:purple          = "cd96e5" " for, in, else
let s:yellow          = "cd96e5" " while loops
let s:green           = "f4b085" " quotes between strings
let s:aqua            = "20af75" " asterick
let s:olive           = "f4b085" " strings
let s:blue            = "65aaca" " function name, public priv, class, if
